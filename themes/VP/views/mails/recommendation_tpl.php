...
<div class="grey">
	...
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
            <?php echo $applicant; ?> has applied to join VenturePact, a marketplace where the best engineering talent can find full time opportunities at the top startups in the world.<br/><br/>

As part of the application process,  <?php echo $applicant; ?> needs people to vouch (aka act as a reference) for them. We keep the talent in our network high quality so recommendations really do matter - we don’t evaluate applicants without them.<br/><br/>

It’s quick, just click this button <br/> <br/> <br/>
...
<br/> <br/> <br/>
            ...
            This is a really important part of the process, so thanks for your help.<br/><br/>
		</td>	
	</tr>
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
