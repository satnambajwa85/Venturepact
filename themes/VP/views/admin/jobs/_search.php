...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'salary_start'); ?>
		<?php echo $form->textField($model,'salary_start'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'salary_end'); ?>
		<?php echo $form->textField($model,'salary_end'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'share_start'); ?>
		<?php echo $form->textField($model,'share_start'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'share_end'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'job_mode_id'); ?>
		<?php echo $form->textField($model,'job_mode_id'); ?>
	</div>
