...
/**
 * This is the model class for table "developer_has_education".
 *
 * The followings are the available columns in table 'developer_has_education':
 * @property integer $id
 ...
 */
class DeveloperHasEducation extends CActiveRecord
{
	/**
	...
	{
		return 'developer_has_education';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, developer_id, schools_id, degree_id, subject_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return DeveloperHasEducation the static model class
	 */
