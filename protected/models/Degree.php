...
class Degree extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, description, add_date, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'developerHasDegrees' => array(self::HAS_MANY, 'DeveloperHasDegree', 'degree_id'),
			'developerHasEducations' => array(self::HAS_MANY, 'DeveloperHasEducation', 'degree_id'),
		);
	}
