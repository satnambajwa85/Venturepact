...
class Schools extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, description, status, state_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'developerHasEducations' => array(self::HAS_MANY, 'DeveloperHasEducation', 'schools_id'),
			'developerHasSchools' => array(self::HAS_MANY, 'DeveloperHasSchools', 'schools_id'),
