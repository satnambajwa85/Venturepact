 ...
 */
class DeveloperRegister extends CActiveRecord
{
	/**
	 * @return string the associated database table name
	 */
	public $educations,$school,$degree,$subject,$previous,$company,$role,$start_time,$end_time,$link,$description,$linkedIn,$twitter,$gitHub,$website,$topCoder,$codeChef,$skill,$rating,$portfolio,$project,$url,$language,$openSource,$openProject,$openUrl,$openDetail,$reference,$recommendation,$referenceId,$referenceName,$referenceEmail,$referencePhone,$recommendationId,$recommendationName,$recommendationEmail,$recommendationPhone,$preference,$question;
